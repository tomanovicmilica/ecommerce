...
export default function ProductDetails() {
  ...
  const ownedDownload = product?.productType === ProductType.Digital ?
    downloads.find(download => download.productId === product.productId && download.isActive !== false && download.canDownload) :
    null;
  ...
  return (
    <div>
      ...
      {/* LEFT IMAGE */}
      <div className="flex justify-center items-start px-4 md:px-8">
        <div className="w-full max-w-md">
          {(product.pictureUrl || product.imageUrl) ? (
            <div className="w-full rounded-2xl shadow-lg overflow-hidden bg-gray-50" style={{ height: '500px' }}>
              <img
            ...
            <div className="w-full rounded-2xl shadow-lg bg-gray-100 flex items-center justify-center" style={{ height: '500px' }}>
              <svg
      ...
      {/* RIGHT DETAILS */}
      <div className="px-4 md:ml-8 lg:ml-16">
